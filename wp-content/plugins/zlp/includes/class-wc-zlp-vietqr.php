...
class WC_Gateway_ZaloPay_VIETQR extends WC_Payment_Gateway
{
	...
	public function __construct()
	{
		...
		$this->method_description = __('Cho phép khách hàng thanh toán qua ứng dụng Zalopay, Zalopay trên Zalo & hơn 40 ứng dụng ngân hàng tại Việt Nam.', 'woocommerce-gateway-zalopay-atm');
		$this->supports           = array(
			'products',
            'refunds',
		);
