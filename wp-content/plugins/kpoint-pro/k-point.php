...
define ('KPOINT_PLUGIN_URL', plugin_dir_url( __FILE__ ));
define( 'KPOINT_PLUGIN_PATH', plugin_dir_path( __FILE__ ) );
...
include 'includes/user-point-table.php';
