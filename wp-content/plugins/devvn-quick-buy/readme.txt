...
* Sửa lại filter ở dòng thông báo trên popup. Trước đây là 'the_content' bây giờ sửa thành 'wpautop'
* Thêm class theme-flatsome với Flatsome Theme để fix css riêng với theme flatsome
