<?php
/**
 * The template for displaying archive pages (category, tags, author, date archives)
 *
 * @package Miliwebseo
 */
...
<div class="bg-gray-50 border-b border-gray-100 py-8 mb-10">
    <div class="container mx-auto px-4 md:px-6">
        <h1 class="text-3xl font-black text-secondary uppercase tracking-wider italic mb-2">
        ...
        <nav class="text-[11px] text-gray-500 uppercase font-bold" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li>
                    <div class="flex items-center">
                        <span class="mx-2 text-gray-300">/</span>
                        <span class="text-gray-400"><?php single_term_title(); ?></span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <main id="primary" class="w-full lg:w-3/4">
            <?php if ( have_posts() ) : ?>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    while ( have_posts() ) :
                        the_post();
                        ?>
                        <article id="post-<?php the_ID(); ?>" <?php post_class( 'bg-white rounded-2xl shadow-sm border border-gray-100/80 overflow-hidden group hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 flex flex-col h-full' ); ?>>
            ...
            <?php else : ?>
                <div class="text-center py-16 bg-white rounded-2xl border border-gray-100 shadow-sm">
                    ...
                    <p class="text-gray-500 font-medium">Chưa có bài viết nào trong chuyên mục này.</p>
                </div>
            <?php endif; ?>
        </main>
