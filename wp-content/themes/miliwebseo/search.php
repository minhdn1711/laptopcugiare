<?php
/**
 * Search Results Template - Product & Blog Search
 */
        ...
        <header class="mb-8">
            ...
            <?php if ( have_posts() ) : ?>
                <p class="text-gray-500 mt-1">
                    Tìm thấy <?php echo $wp_query->found_posts; ?> <?php echo ( get_query_var( 'post_type' ) === 'post' ) ? 'bài viết' : 'sản phẩm'; ?>
                </p>
            <?php endif; ?>
        </header>
