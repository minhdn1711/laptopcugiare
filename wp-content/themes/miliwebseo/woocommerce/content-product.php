...
<div <?php wc_product_class( 'product-card group relative bg-white p-4 flex flex-col h-full hover:shadow-2xl transition-all duration-300 border border-gray-100 rounded-xl overflow-hidden', $product ); ?>>
    ...
    <div class="absolute inset-0 bg-black bg-opacity-85 text-white p-4 opacity-0 translate-y-full group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 text-xs flex flex-col justify-start z-[60] hidden md:flex overflow-auto pointer-events-none">
