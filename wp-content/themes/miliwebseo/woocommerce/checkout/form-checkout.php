...
<!-- Breadcrumb giống trang danh mục sản phẩm -->
...
<div class="bg-gray-50 min-h-screen overflow-x-hidden">
    <div class="container mx-auto px-4 md:px-6 max-w-[1280px]">

        <h1 class="text-2xl md:text-3xl font-black text-secondary uppercase mt-2 mb-8 italic flex items-center gap-3">
